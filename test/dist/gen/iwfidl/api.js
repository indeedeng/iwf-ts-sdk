...
const DefaultApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1WorkflowStateDecidePost: async (workflowStateExecuteRequest, options = {}) => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(workflowStateExecuteRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        apiV1WorkflowStateStartPost: async (workflowStateWaitUntilRequest, options = {}) => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(workflowStateWaitUntilRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
const DefaultApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1WorkflowStateDecidePost(workflowStateExecuteRequest, options) {
         ...
         * @throws {RequiredError}
         */
        async apiV1WorkflowStateStartPost(workflowStateWaitUntilRequest, options) {
...
const DefaultApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1WorkflowStateDecidePost(workflowStateExecuteRequest, options) {
         ...
         * @throws {RequiredError}
         */
        apiV1WorkflowStateStartPost(workflowStateWaitUntilRequest, options) {
...
class DefaultApi extends base_1.BaseAPI {
     ...
     */
    apiV1WorkflowStateDecidePost(workflowStateExecuteRequest, options) {
        return (0, exports.DefaultApiFp)(this.configuration).apiV1WorkflowStateDecidePost(workflowStateExecuteRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary for invoking WorkflowState.waitUntil API
     ...
     */
    apiV1WorkflowStateStartPost(workflowStateWaitUntilRequest, options) {
        return (0, exports.DefaultApiFp)(this.configuration).apiV1WorkflowStateStartPost(workflowStateWaitUntilRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary stop a workflow
